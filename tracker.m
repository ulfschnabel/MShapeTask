...
global Par
Par.color = str2num(get(hObject, 'string'));
...
% Hints: get(hObject,'String') returns contents of linebox as text
%        str2double(get(hObject,'String')) returns contents of linebox as a double
global Par
Par.helpline = str2num(get(hObject, 'string'));

% --- Executes during object creation, after setting all properties.
function linebox_CreateFcn(hObject, eventdata, handles)
% hObject    handle to linebox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
